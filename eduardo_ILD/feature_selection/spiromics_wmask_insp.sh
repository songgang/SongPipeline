...
do
    ...
    do
        ...
        LUNGMASKBIN=/mnt/aibs1/PUBLIC/Data/Output/DrewReconstructionKernelsHRCT/Aug_22_2008/B20inspf/B20inspf-lungmaskbin.nii.gz
        LUNGMASKBINNAME=B20inspf-lungmaskbin
        LOBMASK=/mnt/aibs1/PUBLIC/Data/Output/DrewReconstructionKernelsHRCT/Aug_22_2008/B20inspf/B20inspf-lobe.nii.gz
