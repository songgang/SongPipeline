...
MYDO "$NICKSDT 3 $LUNGMASK $TMPDIR/$LUNGNAME""_lungsdt.nii.gz" 
...
KERNELDIR=/home/songgang/local/segtree/tmp
KERNEL=cyl-
CONV=/home/songgang/mnt/project/imgfea/gccrel-bigmac/fftconvmultimaxidx
C3D=/home/songgang/mnt/pkg/bin/c3d
NICKSDT=/mnt/data1/tustison/Utilities/bin64/GenerateDistanceImage
...
MYDO "$CONV $LUNGIMG $KERNELDIR/$KERNEL 1 276 $TMPDIR/$LUNGNAME""_fmax.nii.gz"
#### MYDO "$C3D $LUNGMASK -threshold 2 3 1 0 -o $TMPDIR/$LUNGNAME""_lungonly.nii.gz" 
...
case "$METHOD" in 
    ...
    "gabor" ) 
        ...
        ;;
    "cylinder" ) 
        echo "use cylinder like gabor filter for segmentation"
        process_cylinder
        ;;
    "mincut" ) 
