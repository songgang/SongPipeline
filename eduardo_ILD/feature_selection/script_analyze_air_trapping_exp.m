...
mlist_at = air_trapping_exp_metric_list();
...
[metric_cat, thres_list] = air_trapping_exp_metric_list();
...
mtable_at_ext = [mtable_aero, mtable_moving_aero, ...
    mtable_severe, ...
    mtable_moving_aero-mtable_severe, ...
    mtable_dyn, ...
    (mtable_dyn+mtable_severe*ones(1,nb_thres))];
...
display_corr_pattern(rho_table, pval_table, 'Air Trapping Volume x PFT Volume in Exp', PFT_data_label, metric_cat_ex, '', 3);


%% dump out the correlation values
[rho_table, pval_table] = get_corr_widx(mtable_at_ext(:, :), PFT_data, ILD_list);
csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-ILD-corr2.csv';
dump_to_csv('correlation', PFT_data_label, metric_cat_ex, rho_table, csv_filename);

[rho_table, pval_table] = get_corr_widx(mtable_at_ext(:, :), PFT_data, COPD_list);
csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-COPD-corr2.csv';
dump_to_csv('correlation', PFT_data_label, metric_cat_ex, rho_table, csv_filename);


csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-COPD-corr_pval2.csv';
dump_to_csv('p-value', PFT_data_label, metric_cat_ex, pval_table, csv_filename);


%% dump out the raw values
csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-ILD-vol.csv';
dump_to_csv('index', metric_cat_ex, find(ILD_list), mtable_at_ext(ILD_list, :), csv_filename);

csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-COPD-vol.csv';
...
mtable_at_ext_normal_lung(:, 5:end-1) = (mtable_moving_aero*ones(1,size(mtable_at_ext,2)-5)) - mtable_at_ext_normal_lung(:, 5:end-1);
...
display_corr_pattern(rho_table, pval_table, 'Normal Lung Volume x PFT Volume', PFT_data_label, metric_cat_ex, '', 9);
...
[rho_table, pval_table] = get_corr_widx(mtable_at_ext_normal_lung(:, :), PFT_data, COPD_list);
csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-COPD-normal-corr2.csv';
dump_to_csv('correlation', PFT_data_label, metric_cat_ex, rho_table, csv_filename);


csv_filename = '/mnt/data/PUBLIC/data1/Data/Output/DrewWarrenLungData/ATCases/Dec_06_2008/script/report/dyn4/exp-COPD-normal-corr_pval2.csv';
dump_to_csv('p-value', PFT_data_label, metric_cat_ex, pval_table, csv_filename);
...
%% plot the raw values
figure(5); % clf;
plot(transpose(mtable_at_ext(ILD_list, :)), '.-');
