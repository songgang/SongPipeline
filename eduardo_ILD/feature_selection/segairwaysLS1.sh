...
MYDO $EXECDIR/Medial 3 $INPUTIMAGE -LS -gradient_sigma 0.1 -speed_beta 0.05 -stop_time 1000 -seed_index '['$SEED']' -freezing_intensity -960 -debug_file_prefix $RESDIR/$LUNGNAME
...
MYDO $C3D $RESDIR/$LUNGNAME"_time.nii.gz" -threshold [0 200 1 0] -o $AIRWAYMASK
