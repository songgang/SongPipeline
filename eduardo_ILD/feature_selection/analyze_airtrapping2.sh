...
MYDO $C3D $OLDRESDIR/mask_resampled.nii.gz $RESDIR/fixed_airway_resampled.nii.gz -scale -1 -shift 1 -multiply $RESDIR/fixed_vessel_resampled.nii.gz -scale -1 -shift 1 -multiply $OLDRESDIR/fixed_resampled.nii.gz -threshold -Inf -300 1 0 -multiply -o $RESDIR/aeroted2_mask_resampled.nii.gz

$BINDIR/CalculateVolumeFromBinaryImage 3 $RESDIR/aeroted2_mask_resampled.nii.gz > $RESDIR/res"-aeroted2-Volume.txt"
...
MYDO $C3D $OLDRESDIR/moving_mask_resampled.nii.gz $RESDIR/moving_airway_resampled_fake.nii.gz -scale -1 -shift 1 -multiply $RESDIR/moving_vessel_resampled.nii.gz -scale -1 -shift 1 -multiply $OLDRESDIR/moving_resampled.nii.gz -threshold -Inf -300 1 0 -multiply -o $RESDIR/moving_aeroted2_mask_resampled.nii.gz

$BINDIR/CalculateVolumeFromBinaryImage 3 $RESDIR/moving_aeroted2_mask_resampled.nii.gz > $RESDIR/res"-moving-aeroted2-Volume.txt"
