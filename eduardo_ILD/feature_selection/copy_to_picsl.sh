...
# copy the air trapping registration data in data1 from bigmac to picsl-frontend-ext 
...
REMOTEHOST=picsl-frontend-ext
DSTROOT=/home/songgang/localdata/DrewWarrenLungData/ATCases/Dec_06_2008
